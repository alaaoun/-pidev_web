 ...
 */
class Station extends \App\Entity\Station implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Station' . "\0" . 'idStation', '' . "\0" . 'App\\Entity\\Station' . "\0" . 'lieu', '' . "\0" . 'App\\Entity\\Station' . "\0" . 'etat', '' . "\0" . 'App\\Entity\\Station' . "\0" . 'name'];
        }
    ...
    public function getIdStation(): ?int
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdStation();
        }
